      ...
      <main className="min-h-[calc(100vh-64px)] bg-[#F4F7F4] px-5 py-8">
        <section className="mx-auto max-w-3xl rounded-lg border border-[#E2EBE6] bg-white p-7">
          ...
          <p className="mt-4 text-sm leading-relaxed text-[#6B7B8D]">
            Slide Engage is a platform for creating live classroom and presentation interactions. Lecturers are responsible for the content they create, the sessions they run, and any participant data they collect.
          </p>
          <p className="mt-4 text-sm leading-relaxed text-[#6B7B8D]">
